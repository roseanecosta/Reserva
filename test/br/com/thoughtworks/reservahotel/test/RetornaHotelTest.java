...
import br.com.thoughtworks.reserva.model.RetornaHotel;
import br.com.thoughtworks.reserva.model.Ridgewood;
...
public class RetornaHotelTest {
    ...
    @Test
    public void retornarClassicacao() throws ParseException {

        ArrayList<Hotel> hoteis = new ArrayList<Hotel>();
        hoteis.add(bridgewood);
        hoteis.add(ridgewood);

        assertEquals("Ridgewood", retornaHotel.retornarClassificacao(hoteis));
